...
1. **One formula across silicon and sim.** Robstride firmware computes
   ...
   `bar_hw_robstride/RobstrideSystem` encodes the five fields straight
...
`bar_hw_robstride/include/bar_hw_robstride/robstride_protocol.hpp`.
`bar_hw_robstride/RobstrideSystem::write` does the scale-and-pack;
`read` reverses it.
...
- The protocol header in
  [`bar_hw_robstride/robstride_protocol.hpp`](https://github.com/T-K-233/bar_ros2/blob/main/bar_hw_robstride/include/bar_hw_robstride/robstride_protocol.hpp)
