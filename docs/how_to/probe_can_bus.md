...
load the JSON). It's the raw absolute-encoder reading. If it's
plausibly in `[-4π, 4π]` and the motor reports temp around room
...
| `robstride_discover` reports | Likely cause |
|---|---|
