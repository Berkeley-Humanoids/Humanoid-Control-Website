...
`lite_sdk2` (the `bar_msgs` types generated by
[`bar_msgs_dds`](packages.md#bar_msgs_dds) plus the DDS channel layer)
rather than hand-writing message mirrors — see
[Talk to bar_ros2 from Python](../how_to/talk_to_bar_ros2_from_python.md). See
